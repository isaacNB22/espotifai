          ...
          children: [
            ...
            if (song.downloaded)
              const Padding(
                ...
                child: Icon(Icons.download_done_rounded, size: 16, color: Color(0xFF1DB954)),
              ),
            if (showDownloadButton && onDownload != null)
              _ActionBtn(icon: Icons.download_rounded, tooltip: 'Descargar MP3', onTap: onDownload!),
            if (showAddButton && onAddToLibrary != null)
              _ActionBtn(icon: Icons.add_rounded, tooltip: 'Agregar a biblioteca', onTap: onAddToLibrary!),
            if (onDelete != null)
              _ActionBtn(icon: Icons.delete_outline_rounded, tooltip: 'Eliminar', onTap: onDelete!),
            _ActionBtn(
              icon: isPlaying
